...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/ExodusMovement/react-native-menu/archive/refs/tags/v#{s.version}.tar.gz", :sha256 => "3ae8dfa9908a1cfcf2528e574b2a518c1ca3dbb34fff763d6bc1545d4f84a477" }
